...
<form id="unlock"><h2>Open your vault dashboard</h2><p>Enter the vault ID and the pairing key from your deployment. The key stays in memory until you lock or close this page.</p><label>Vault ID<input id="vault" value="default" required maxlength="128" autocomplete="off"></label><label>Pairing key<input id="key" type="password" required autocomplete="off"></label><button type="submit">Unlock dashboard</button></form>
<div id="dashboard" hidden><div class="section-head"><h2 id="vault-name"></h2><small id="version"></small></div><div class="toolbar"><button id="refresh" type="button">Refresh</button><button id="copy-key" type="button" class="quiet">Copy pairing key</button><button id="lock" type="button" class="quiet">Lock dashboard</button><small id="updated"></small></div>
